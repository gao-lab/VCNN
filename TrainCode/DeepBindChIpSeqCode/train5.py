...
def run_chipseq_data(KernelLen, KernelNum, RandomSeed):
    def get_data_info_list(root_dir = "", root_dir2=""):
        # 78 in total
        pre = glob.glob(root_dir+"*Helas3*")
        pre2 = glob.glob(root_dir2+"*Huvec*")
        pre.extend(pre2)
    ...
    root_dir2 = "../../Data/ChIPSeqData/HDF5/"
    result_root = "../../OutPutAnalyse/result/ChIPSeq/"
    data_info_lst = get_data_info_list(data_root,root_dir2)
    cell = "chipseq"
