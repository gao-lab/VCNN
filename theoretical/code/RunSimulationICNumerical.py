...
def main(MotifName, length, pideal):
	...
	# pythonPath = "/home/gaog_pkuhpc/users/lijy/anaconda3/bin/python ./SimulationICNumerical.py"
	pythonPath = "/home/lijy/anaconda3/bin/python ./SimulationICNumerical.py"
