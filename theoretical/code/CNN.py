"""
in this part, we test how kernel length infect the performance of CNN
"""
...
def DrawBoxPlot(Dataname, path):
	...
	plt.text(0, 0.95, Dataname,fontsize=12)
	# Pddict.boxplot()
...
if __name__ == '__main__':
	...
	path = ["../../Data/ICSimulation/HDF5/simu_01/","../../Data/ICSimulation/HDF5/simu_02/"]
