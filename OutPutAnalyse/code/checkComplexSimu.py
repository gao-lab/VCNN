...
if __name__ == '__main__':
    ...
    for item in model_lst:
        ...
        mkdir("../../OutPutAnalyse/ModelAUC/MoreComplexSituation/")
        Df.to_csv("../../OutPutAnalyse/ModelAUC/MoreComplexSituation/"+ item + "AUC.csv")
        for key in aucouttem.keys():
            print(key)
            np.savetxt("../../OutPutAnalyse/ModelAUC/MoreComplexSituation/" + key +"_" + item + "_auc.txt", np.asarray(aucouttem[key]))
    ...
    DrawBox(dataName, "../../OutPutAnalyse/ModelAUC/MoreComplexSituation/")
