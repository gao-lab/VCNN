'''
final version for vCNN explain
...
explain_save_root = explain_root + "result/raw_result/"
# save the visualized result under this dir
explain_img_dir = explain_root + "result/explain_img/"
...
explain_model_root = explain_root + "result/simu_result/"
# save the average AUC bar plot for CNN, with respect to different kernel length
CNN_average_AUC_dir = explain_root + "result/simu_kerLen_auc/"
