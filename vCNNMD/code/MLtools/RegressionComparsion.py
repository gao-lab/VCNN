...
def GetFeatures(MotifFile, seqs):
    """
    拿到每个motif对应的每个seq上的卷积分数，阳性阴性都需要
    :param MotifFile:
    :param seqs:
    :return:
    """
...
def RegressionFunc(TrainX, TrainY, TestX, TestY):
    """
    返回模型
    :param TrainX:
    :param TestX:
...
def Regression(filePath, fileName):
    """
    使用cisFinder Scan找peak点
    :param filePath: fasta的路径
    :param motifFile:
    :param fileName:
    :return:
    """
